...
module.exports = {
	...
	langs: {
		...
		en: {
			help: "╭───𓆩𝙀𝙇𝙄𝙏𝙀 𝙀𝙁-𝙋𝙍𝙄𝙈𝙀────────⦿"
				...
				+ "\n✪──────⦿"
				+ "\n✪ Page [ %2/%3 ]"
				+ "\n│ 𝐂𝐮𝐫𝐫𝐞𝐧𝐭𝐥𝐲, 𓆩𝙀𝙇𝙄𝙏𝙀 𝙀𝙁-𝙋𝙍𝙄𝙈𝙀 𝐇𝐚𝐬 %4 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 𝐓𝐡𝐚𝐭 𝐂𝐚𝐧 𝐁𝐞 𝐔𝐬𝐞𝐝"     + "\n│ 𝐓𝐲𝐩𝐞 %5𝐡𝐞𝐥𝐩 <𝐩𝐚𝐠𝐞> 𝐓𝐨 𝐕𝐢𝐞𝐰 𝐓𝐡𝐞 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐋𝐢𝐬𝐭"     + "\n│  𝐓𝐲𝐩𝐞 %5𝐡𝐞𝐥𝐩 𝐓𝐨 𝐕𝐢𝐞𝐰 𝐓𝐡𝐞 𝐃𝐞𝐭𝐚𝐢𝐥𝐬 𝐎𝐟 𝐇𝐨𝐰 𝐓𝐨 𝐔𝐬𝐞 𝐓𝐡𝐚𝐭 𝐂𝐨𝐦𝐦𝐚𝐧𝐝"
				+ "\n✪──────⦿"
				+ "\n✪ %6"
				+ "\n╰─────────────⦿",
			help2: "%1╭──────────⦿"
				+ "\n│ 【𝐂𝐌𝐃】「%2」"     + "\n│ 【𝐔𝐒𝐀𝐆𝐄】「%3𝐇𝐄𝐋𝐏⁌𝐂𝐌𝐃𝐍𝐀𝐌𝐄⁍」\n│【𝐎𝐖𝐍𝐄𝐑】「 Frank kaumba |𓆩𝙀𝙇𝙄𝙏𝙀 𝙀𝙁-𝙋𝙍𝙄𝙈𝙀」 "
				+ "\n╰─────────────⦿\n╭─────────────⦿\n│%4\n╰────────────⦿",
			commandNotFound: "Command \"%1\" does not exist",
			getInfoCommand: "╭────⦿ 𓆩𝙀𝙇𝙄𝙏𝙀 𝙀𝙁-𝙋𝙍𝙄𝙈𝙀──────⦿"
				+ "\n✪ %1"
				+ "\n✪▫INFO"
				+ "\n✪ Description: %2"
				+ "\n✪ Other names: %3"
	...
	onStart: async function ({ message, args, event, threadsData, getLang, role }) {
		...
		// ———————————— COMMAND DOES NOT EXIST ———————————— //
			...
			return message.reply(getLang("commandNotFound on 𓆩𝙀𝙇𝙄𝙏𝙀 𝙀𝙁-𝙋𝙍𝙄𝙈𝙀", args[0]));
		}
		// ————————————————— INFO COMMAND ————————————————— //
		else {
